		...
		return (
			<View>
				...
				<TouchableOpacity onPress={() => this.setState({ showPassword: !showPassword })} style={style.btnIconPass}>
					<FontAwesome name={showPassword ? 'eye-slash' : 'eye'} allowFontScaling style={style.iconPass} />
				</TouchableOpacity>
			...
			<View>
				<View style={style.regresarContenedor}>
					<TouchableOpacity onPress={() => this.setState({ showCrearCuenta: false })}>
						<FontAwesome name={'arrow-left'} allowFontScaling style={style.iconRegresar} />
					</TouchableOpacity>
