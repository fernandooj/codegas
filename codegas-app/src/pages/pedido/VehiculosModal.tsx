...
import { View, Text, TouchableOpacity, FlatList, Image, Alert, Modal } from 'react-native';
...
const VehiculosModal: React.FC<VehiculosModalProps> = ({
    ...
    const renderVehiculoItem = useCallback(({ item: e }: { item: Vehiculo }) => {
    ...
    }, [idVehiculo, placa, onVehicleSelect, onToggleCalendar]);
