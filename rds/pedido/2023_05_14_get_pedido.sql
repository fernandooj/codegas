...
BEGIN
    IF _acceso = 'admin' THEN
        RETURN QUERY 
        SELECT p._id, p.creado, p.fechaSolicitud, p.fechaEntrega, p.forma, p.cantidadKl, p.cantidadPrecio, p.estado, p.entregado, p.novedades, p.imagenCerrar, p.valorUnitario, u.codt, u.razon_social, u.nombre, u.cedula, pt.direccion, pt.capacidad, c.placa, z.nombre,  u2.nombre, u3.nombre
        FROM pedidos p
