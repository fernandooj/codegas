  ...
  renderTable(){
    const columns = [
      ...
      },
      {
        ...
        dataIndex: 'usuarioId',
        width: '12%',
        render: text => <p>{text.razon_social}</p>, 
      },
      {
        title: 'Cedula',
        dataIndex: 'usuarioId',
      ...
      { 
        title: 'Dirección',
        dataIndex: 'puntoId',
        render: puntoId => <p>{puntoId.direccion}</p>, 
        width: '12%',
      },
      {
        title: 'Zona',
      ...
      },
      {
        ...
        dataIndex: 'carroId',
        render: carroId => <p>{carroId.placa}</p>, 
      ...
      },
      {
        ...
        render:(carro, e)=>(
          <Zoom>
            <img src={e.imagenCerrar} style={{width:"40px"}} />
          </Zoom>
        ), 
        onFilter: (value, record) => record.estado.indexOf(value) === 0,
        sorter: (a, b) => a.estado.length - b.estado.length,
          ...
          this.props.vehiculos.map(e=>{
              return <div
                  ...
                  <div>
                    ...
                    >{e.conductor ? e.conductor.nombre :""}</p>       
                  </div>
                  {
                    e.conductor
