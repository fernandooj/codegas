            ...
            {/* BOTON GUARDAR */}
                ...
                }
                {
                   (tipoAcceso=="editar" && (accesoPerfil=="admin" || accesoPerfil=="veo"))
                    &&<TouchableOpacity style={[style.btnGuardar, {backgroundColor:"#feac00", marginBottom:0} ]} onPress={()=>this.props.navigation.navigate("chart", {idUsuario})}>
                        <Text style={style.textGuardar}>{"Graficos"}</Text>
                    </TouchableOpacity> 
                }
                {
                    (tipoAcceso=="editar" && (accesoPerfil=="admin" || accesoPerfil=="despacho"))
                    &&<TouchableOpacity style={[style.btnGuardar, {backgroundColor:"blue", marginBottom:70} ]}  onPress={()=>this.props.navigation.navigate("puntos", {idUsuario})}>
